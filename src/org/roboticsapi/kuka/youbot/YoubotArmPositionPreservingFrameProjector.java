...
public class YoubotArmPositionPreservingFrameProjector implements FrameProjector {

	private final YoubotArm youbot;

	public YoubotArmPositionPreservingFrameProjector(YoubotArm youbot) {
		this.youbot = youbot;
	...
	public RelationSensor project(RelationSensor toProject, DeviceParameterBag parameters)
		...
		return new RelationSensor(new PositionPreservingFrameProjectionSensor(youbot.getDriver().getRuntime(),
				toProject, flangeToMotionCenter), youbot.getBase(), youbot.getFlange());
	}
}
