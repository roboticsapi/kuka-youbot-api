 ...
 */
public final class EthercatBasedYoubotGripperDriver extends SoftRobotYoubotGripperDriver {

	private static final String DEVICE_TYPE = "kuka_youbot_gripper_ec";
	private EthercatDriver ethercatDriver = null;

	public EthercatBasedYoubotGripperDriver() {
		super();
	}
