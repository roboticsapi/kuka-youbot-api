...
package org.roboticsapi.kuka.youbot.controller;

/**
 * Joint Impedance Setting for youBot offers stiffness, damping and additional
 * torque
 */
public class JointImpedanceSettings {
	...
	/**
	 * Constructor for Impedance setting of one youBot joint
	 * 
	...
	/**
	 * onstructor for Impedance setting of one youBot joint
	 * 
	 * @param stiffness stiffness value in Nm/rad
	 * @param damping   damping value in 0..1 range
	 * @param addTorque additional torque in Nm
